...
const Organizer = ({
    ...
    return (
      ...
      <Seo title={"Visualize by Major Organizers"}/>
        ...
        <BarGraph data={populationGraphData} title={"Number of Japanese Residents in Singapore Over Time"} xaxis={"year"} yaxis={"value"} yaxisName={"Number of Japanese Residents"}/>

        <PieChart data = {sponsorGraphData} radius = {100} innerRadius={30} containerHeight={400} color={"#5b0e2d"} title="The Sponsors of Japanese Performances"/>
