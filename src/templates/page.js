...
import image1 from "../images/SLIDE CAROUSEL_ninagawa macbeth.jpg"
import image2 from "../images/SLIDE CAROUSEL_ninagawa macbeth 2.jpg"
import image3 from "../images/SLIDE CAROUSEL_kafka.jpeg"
import image4 from "../images/SLIDE CAROUSEL_3 titans shun-kin 2013 .jpeg"
  ...
  return (
    <Layout>
      ...
      {pageTitle == "Introduction" && (
        ...
        <Carousel autoPlay infiniteLoop width="100%" interval="2000" showThumbs = {false}>
          <div>
              <img src={image1} height = "500px"/>
              <p className="legend">Ninagawa macbeth</p>
          </div>
          <div>
          ...
          <div>
              <img src={image3} height = "500px"/>
              <p className="legend">Kafka</p>
          </div>
          <div>
              <img src={image4} height = "500px"/>
              <p className="legend">Titans Shun-kin 2013</p>
          </div>
            </Carousel>
      ...
      <Container>
          ...
          {pageTitle == "Venues" && 
            <table>
              ...
              <tr>
                <td>
                  <img src = {venue1} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue2} width = "300px" height = "200px"/>
                </td>
                <td>Drama Centre</td>
              ...
              <tr>
                <td>
                  <img src = {venue3} width = "300px" height = "200px"/>
                </td>
                <td>Esplanade</td>
              ...
              <tr>
                <td>
                  <img src = {venue4} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue5} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue6} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue7} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue8} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue9} width = "300px" height = "200px"/>
                </td>
              ...
              <tr>
                <td>
                  <img src = {venue10} width = "300px" height = "200px"/>
                </td>
