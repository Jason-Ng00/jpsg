        ...
        {activeSegment === 1 &&  
              ...
              <Row>
                <Col xs={5} md={5} lg={5} style={{display:"flex", flexDirection:"column", justifyContent:"center"}}>
                  ...
                  troupes, such as the Kinoshita Circus, arriving. One of the most interesting performances 
                  during the prewar era was the visit of Takarazuka, they dropped by Singapore in October 
            ...
            {activeSegment === 2 && 
              ...
              <h3>Immediate postwar to the announcement of the Fukuda Doctrine in 1977  </h3>
                  ...
                  Japanese Cultural Society, Singapore(1963); the Agency of Cultural Affairs (1968).  
              </p>
              <p>
                Visiting performers from Japan was not very active yet, but we saw several charity shows, especially in the 
                early fifties and sixties such as this 1968 show at the National Theatre by the Takarazuka Revue, with profit 
                went to the National Theatre Trust. There were a variety of performances including the Kinoshita Circus and the 
                Tokyo Philharmonic Orchestra, although the numbers are not high. 
              </p>
              </Col>
            </Row>
            </Container>
            ...
            <Col xs={7} md={7} lg={7}>
              ...
              But from 2019 March onwards, with boarder closure and many other safety restrictions, physical performance came to a sudden halt, as can be seen here.  </p>
              </Col>
            </Row>
            </Container>
