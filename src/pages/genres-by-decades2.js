            ...
            {activeDecade === "2000s" && (
              <Container>
                <Row>
                  ...
                  <Col>
                    <PieChart
                      data={numberPerformanceByGenreAndDecades[4]}
                      radius={100}
                      innerRadius={30}
                      containerHeight={500}
                      color={"#213970"}
            ...
            {activeDecade === "2010s" && (
              <Container>
                <Row>
                  <Col>
                    <PieChart
                      data={numberPerformanceByGenreAndDecades[5]}
                      radius={100}
                      innerRadius={30}
                      containerHeight={500}
                      color={"#5b0e2d"}
