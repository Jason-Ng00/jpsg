...
const GenresByDecades2 = ({
  ...
  chartData.nodes.map(event => 
    ...
    return (
      ...
      <ParallaxLayer sticky={{ start: 1, end: 6 }} style={{ ...alignCenter, justifyContent: 'flex-end' }}>
      <Container  style={atTop ? atTopStyle : notAtTopStyle}>
        ...
        <ParallaxLayer offset={1} speed={1.5} style={{ ...alignCenter, justifyContent: 'flex-start' }}>
        ...
        <ParallaxLayer offset={2} speed={1.5} style={{ ...alignCenter, justifyContent: 'flex-start' }}>
      ...
      <ParallaxLayer offset={3} speed={1.5} style={{ ...alignCenter, justifyContent: 'flex-start' }}>
        ...
        <ParallaxLayer offset={4} speed={1.5} style={{ ...alignCenter, justifyContent: 'flex-start' }}>
        <VisibilitySensor partialVisibility>
          {({ isVisible }) => (
            <Spring delay={100} to={{ opacity: isVisible ? 0.6 : 0 }}>
              {({ opacity }) => (<Container style={{ opacity }}> 
        ...
        <ParallaxLayer offset={5} speed={1.5} style={{ ...alignCenter, justifyContent: 'flex-start' }}>
        ...
        <ParallaxLayer offset={6} speed={1.5} style={{ ...alignCenter, justifyContent: 'flex-start' }}>
...
export default GenresByDecades2
